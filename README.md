...
Preprocessed Japanese training material is provided with [つくよみちゃんコーパス(tsukuyomi-chan corpus).](https://tyc.rei-yumesaki.net/material/corpus/) You need to download the corpus and place 100 `.wav` files to `./tsukuyomi_raw`. 
</br>

- Currently Supported: Japanese / Korean: Single Speaker
- Multi-speaker / Chinese / CJKE / and other languages will be updated very soon!
